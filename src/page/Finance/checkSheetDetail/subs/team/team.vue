...
<template>
  <div class="check-sheet-detail">
    <header>
      ...
      <div class="button-ground" v-show="type=== 'add'">
      ...
      <div class="button-ground" v-show="type=== 'normal'">
        <el-button type="primary" size="small" @click="printHandler">打印</el-button>
        <el-button type="info" size="small" @click="backPage">取消</el-button>
      </div>
      <div class="button-ground" v-show="type=== 'mine'">
...
export default {
  ...
  methods: {
    ...
    choosePageType() {
      ...
      this.$router.replace({
        path,
        query: { id, planID, isCheckSheet, tab, workItemID, guid, comeFrom }
      });
    ...
    backPage() {
      let { tab, comeFrom } = this.$route.query;
      ...
      this.isFromCheckSheet
        ? this.$router.replace({
            ...
            query: { tab, conditions: this.cacheConditions }
          })
