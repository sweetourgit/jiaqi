<template>
  <div class="oppo" style="position:relative">
    <!--认收款-->
    <el-dialog title="认收款" :visible="dialogFormVisible2" width=90% @close="closeAdd" append-to-body>
      <div class="recognitionCls">

        <!-- 顶部基础信息 -->
        <div class="topMsg">
          <p class="inputLabel" v-if="collectionType == 2"><span>同业社名称：</span>{{baseInfo.localCompName}}</p>
          <p class="inputLabel" v-if="collectionType == 1"><span>交易流水号：</span>{{baseInfo.orderNumber}}</p>
        ...
        <!-- 订单信息table -->
        <el-table ref="multipleTable" :data="tableDataOrder" border style="width: 100%;" :header-cell-style="getRowClass">
          ...
          <el-table-column prop="matchingPrice" label="本次收款金额" align="center">
          </el-table-column>
        </el-table>
        ...
        <div class="recognition">
          <el-tabs :tab-position="tabPosition" v-model="activeName">
            <el-tab-pane label="中国银行" name="bankZH">
              ...
              <div class="block">
                <el-pagination @size-change="handleSizeChangeZH" @current-change="handleCurrentChangeZH" :current-page.sync="pageCurrentZH" :page-sizes="[5, 10, 50, 100]" :page-size="pageSizeZH" layout="total, sizes, prev, pager, next, jumper" :total='totalZH'>
                </el-pagination>
              </div>
            </el-tab-pane>
            <el-tab-pane label="兴业银行" name="bankXY">
              ...
              <div class="block">
                <el-pagination @size-change="handleSizeChangeXY" @current-change="handleCurrentChangeXY" :current-page.sync="pageCurrentXY" :page-sizes="[5, 10, 50, 100]" :page-size="pageSizeXY" layout="total, sizes, prev, pager, next, jumper" :total='totalXY'>
                </el-pagination>
              </div>
            </el-tab-pane>
            <el-tab-pane label="所选明细" v-if="isShow" name="bankMX">
              ...
              <div class="block">
                <el-pagination @size-change="handleSizeChangeMX" @current-change="handleCurrentChangeMX" :current-page.sync="pageCurrentMX" :page-sizes="[5, 10, 50, 100]" :page-size="pageSizeMX" layout="total, sizes, prev, pager, next, jumper" :total='totalMX'>
                </el-pagination>
              </div>
            </el-tab-pane>
          </el-tabs>
