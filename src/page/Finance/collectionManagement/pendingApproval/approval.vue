  ...
  <div class="vivo" style="position:relative" id="collectionDetail">
    ...
    >
      <div class="buttonDv">
        ...
        >查看</el-button>
        <!-- 报销还款审批页的去认款按钮显示end -->
        <el-button type="success" @click="touchPrint" plain v-if="(getOrgID == 491 || getOrgID == 310 || getOrgID == 342 || getOrgID == 362 || getOrgID == 542) && (info.collectionType != 6)">打印本页详情</el-button>
      </div>
