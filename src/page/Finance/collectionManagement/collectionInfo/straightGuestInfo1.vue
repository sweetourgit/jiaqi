<template>
  <div class="vivo" style="position:relative">
    <el-dialog :title="title" :visible="dialogFormVisible" width=60% :show-close="false" class="addReceivables" @close="closeAdd">
      ...
      <div v-show="ruleForm.checkType === 0" class="sh_style">审核中</div>
      <div v-show="ruleForm.checkType == 1" class="sh_style" style="background: #008000; color: #fff;">通过</div>
      <div v-show="ruleForm.checkType == 2" class="sh_style" style="background: #FF0000; color: #fff;">驳回</div>
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          objectRequest = {
            ...
            planID: this.ruleForm.planID == '' ? 0 : this.ruleForm.planID, //团期计划的ID
            orderID: this.ruleForm.orderID == '' ? 0 : this.ruleForm.orderID, //订单ID
