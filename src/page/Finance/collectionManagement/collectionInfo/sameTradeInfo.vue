        ...
        <el-table :data="arrearsList" border :header-cell-style="getRowClass">
           ...
           <el-table-column label="匹配收款金额" align="center" width="180">
              <template slot-scope="scope">
                ...
                <el-input-number :controls="false" size="small" v-model="scope.row.matchingMoney" :disabled="scope.row.isDisabled" placeholder="匹配收款金额" @blur="handleCollectionPrice(scope.row.matchingMoney)"></el-input-number>
              </template>
           </el-table-column>
        </el-table>
        <!-- 关联欠款 END -->
