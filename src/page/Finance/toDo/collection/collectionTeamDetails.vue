...
<template>
  <div class="loan-management">
    ...
    <div>
      ...
      <div v-if="keepComponentName === 'nameIIICollectionTeamDirect'">
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{ fundamental.id }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">申请人:</div></el-col>
            <el-col :span="16"><div class="grid-del ">{{ fundamental.createUser }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">创建时间:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.createTime | formatDate }}</div></el-col>
          </el-col>
        </el-row>
        <!-- 第一行 END -->
        <!-- 第二行 -->
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{ fundamental.serialNumber }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">收款账户:</div></el-col>
            <el-col :span="16" style="line-height: 15px;"><div class="grid-del">{{ fundamental.collectionNumber }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">收款金额:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.price }}</div></el-col>
          </el-col>
        </el-row>
        <!-- 第二行 END -->
        <!-- 第三行 -->
        <el-row type="flex" class="row-bg" justify="space-around">
          ...
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{ fundamental.abstract }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">开发票:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.invoice == 1 ?  '是' : '否' }}</div></el-col>
          </el-col>
        </el-row>
        <!-- 第三行 END -->
        <!-- 第四行 -->
      ...
      <div v-if="keepComponentName === 'nameIIICollectionTeamSame'">
         ...
         <el-row type="flex" class="row-bg" justify="space-around">
           <el-col :span="6">
             ...
             <el-col :span="16"><div class="grid-del">{{ fundamental.localCompName }}</div></el-col>
           </el-col>
           <el-col :span="6">
             <el-col :span="6"><div class="grid-del label-color">收款账户:</div></el-col>
             <el-col :span="16"><div class="grid-del">{{ fundamental.collectionNumber }}</div></el-col>
           </el-col>
           <el-col :span="6">
             <el-col :span="6"><div class="grid-del label-color">收款金额:</div></el-col>
             <el-col :span="16"><div class="grid-del">{{ fundamental.price }}</div></el-col>
      ...
      <div v-if="keepComponentName === 'nameIIICollectionTeamInner'">
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{ fundamental.distributor }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">收款账户:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.collectionNumber }}</div></el-col>
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">收款时间:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.collectionTime | formatDate }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">摘要:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.abstract }}</div></el-col>
          ...
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{ fundamental.moneyExplain }}</div></el-col>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
      ...
      <div v-if="keepComponentName === 'nameIIICollectionTeamReimburse'">
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{ fundamental.reimbursement }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">借款单号:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.loan }}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">收款金额:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.price }}</div></el-col>
        ...
        <el-row type="flex" class="row-bg" justify="space-around">
          <el-col :span="6">
            ...
            <el-col :span="16"><div class="grid-del">{{fundamental.accountID == 13 ? "现金" : "汇款"}}</div></el-col>
          </el-col>
          <el-col :span="6">
            <el-col :span="6"><div class="grid-del label-color">收款账户:</div></el-col>
            <el-col :span="16"><div class="grid-del">{{ fundamental.collectionNumber }}</div></el-col>
      ...
      <div v-if="keepComponentName !== 'nameIIICollectionTeamReimburse'">
        <!-- 表格信息 -->
        <el-collapse v-model="collapseName" style="margin-top: 30px;">
          <!-- 审核结果 -->
            ...
            <el-table :data="tableAuditResults" border :header-cell-style="getRowClass">
              ...
              <el-table-column label="审批结果" align="center">
                <template slot-scope="scope">
                  <div v-if="scope.row.spState === '审批中'" style="color: #7F7F7F" >{{ scope.row.spState }}</div>
                  <div v-if="scope.row.spState === '驳回'" style="color: #FF4A3D" >{{ scope.row.spState }}</div>
                  <div v-if="scope.row.spState === '通过'" style="color: #33D174" >{{ scope.row.spState }}</div>
                </template>
              </el-table-column>
          ...
          <!-- 审核结果 -->
          <!-- 发票 -->
          <el-collapse-item class="collapse-m" name="collapseInvoice">
            <template slot="title">
          ...
          <!-- 发票 END -->
          <!-- 同业/直客关联欠款 -->
          <el-collapse-item class="collapse-m" name="collapseAssociated" v-if="paramsCollectionType === 2 || paramsCollectionType === 1">
            <template slot="title">
          ...
          <!-- 同业/直客关联欠款 END -->
          <!-- 内部收款，关联欠款 -->
          <el-collapse-item class="collapse-m" name="collapseInner" v-else-if="paramsCollectionType === 5">
            <template slot="title">
              <el-divider content-position="left">关联欠款</el-divider>
            </template>
            <div class="stepDv bottomDis">
              <el-table :data="tableAssociated" border :header-cell-style="getRowClass">
                ...
                <el-table-column prop="suppliers" label="分销商" width="60" align="center"></el-table-column>
                <el-table-column prop="productName" label="产品名称" align="center"></el-table-column>
                <el-table-column prop="groupCode" label="团期计划" align="center"></el-table-column>
                <el-table-column prop="payablePrice" label="订单金额" align="center"></el-table-column>
