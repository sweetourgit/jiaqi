<template>
  <div>
    <el-drawer
      ...
      :show-close="false"
      class="loan-management"
    >
      <el-divider class="mb-40">订单信息</el-divider>
      <div class="el-drawer-content">
        <el-divider content-position="left" class='title-margin-t'>基本信息</el-divider>
        <div>
          ...
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              ...
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.groupCode }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">下单时间:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ moment(orderList.createTime).format("YYYY-MM-DD") }}</div></el-col>
            </el-col>
            <el-col :span="6">
          ...
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              ...
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.payable | numFilter }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">已付金额:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.paid | numFilter }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">订单ID:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.orderCode }}</div></el-col>
            </el-col>
          </el-row>
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">套餐:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.package }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">出发地:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.pod }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">目的地:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del ">{{ orderList.destination }}</div></el-col>
            </el-col>
          </el-row>
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">出发日期:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.date }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">电话:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.contactTel }}</div></el-col>
            </el-col>
            <el-col :span="6">
          ...
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              ...
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.contactName }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">数量:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.number }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">其他费用:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.otherPrice }}</div></el-col>
            </el-col>
          </el-row>
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">整体优惠:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.entiretyFav }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">销售:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.indirectSale }}</div></el-col>
            </el-col>
            <el-col :span="6">
          ...
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
              ...
              <el-col :span="17" class="base-value"><div class="grid-del">{{0}}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">操作:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.op }}</div></el-col>
            </el-col>
            <el-col :span="6">
              <el-col :span="7"><div class="grid-del label-color">商户销售:</div></el-col>
              <el-col :span="17" class="base-value"><div class="grid-del">{{ orderList.saler }}</div></el-col>
            </el-col>
          </el-row>
          <el-row type="flex" class="row-bg" justify="space-around">
            <el-col :span="6">
