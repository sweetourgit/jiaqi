  ...
  <div class="all" id="noIncomeBorrowing">
    <div class="borders">
          ...
          <el-row>
            ...
            <el-col :span="9">
              <div class="buttonDv">
                ...
                <el-button type="primary" @click="exportFun(ruleForm, 3)" :disabled="canExport">导出</el-button>
              </div>
            </el-col>
          </el-row>
        </div>
      ...
      <div class="table_style">
        <div class="totalMoney" v-if="isShow"><i class="el-icon-info"></i>&nbsp;&nbsp;已关联：{{num3}}项 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总计：{{totalMoney3}}元</div>
        <el-table :data="tableData3" :header-cell-style="getRowClass" border>
  ...
  export default {
    ...
    methods: {
      ...
      searchFun(){
        ...
        this.loadFinished(this.ruleForm,'BalancePayment_ZB');
      },
      // 重置
      resetFun(){
