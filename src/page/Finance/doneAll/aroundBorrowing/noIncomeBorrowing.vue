  ...
  <div class="all" id="noIncomeBorrowing">
    <div class="borders">
          ...
          <el-row>
            <el-col :span="9" :offset="14">
              <div class="buttonDv">
                ...
                <el-button type="primary" @click="exportFun(ruleForm, 1)" :disabled="canExport">导出</el-button>
              </div>
            </el-col>
          </el-row>
        </div>
      ...
      <div class="table_style">
        <div class="totalMoney" v-if="isShow"><i class="el-icon-info"></i>&nbsp;&nbsp;已关联：{{num1}}项 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总计：{{totalMoney1}}元</div>
        <el-table :data="tableData1" :header-cell-style="getRowClass" border>
  ...
  export default {
    ...
    methods: {
      ...
      searchFun(){
        ...
        this.loadFinished(this.ruleForm,'NoIncomeLoan_ZB');
      },
      // 重置
      resetFun(){
