<template>
  <div class="vivo" style="position:relative">
    ...
    <InvoiceDetails :dialogVisible="dialogVisible3" :pid="pid" @close="closeAdd"></InvoiceDetails>
  </div>
</template>
<script type="text/javascript">
import InvoiceDetails from '@/page/Finance/pledgingManagement/pledgingManagementInfo/invoiceDetails'
export default {
  name: "approval",
  components: {
    InvoiceDetails
