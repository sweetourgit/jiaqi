    ...
    <el-dialog title="查看订单" :visible="dialogFormVisible" width="70%" @close="closeAdd">
      ...
      <div class="table_trip" v-if="tableData.length == 0">
        ...
        >
          <template v-if="isOrder">
            ...
            <el-table-column prop="contactTel" label="电话" align="center"></el-table-column>
            <el-table-column prop="createTime_dt" label="下单时间" align="center"></el-table-column>
            <el-table-column prop="price" label="收款金额" align="center"></el-table-column>
          </template>
          <template v-else>
            <el-table-column prop="orderCode" label="收款单号" align="center"></el-table-column>
            <el-table-column prop="orderCode" label="报销单号" align="center"></el-table-column>
            <el-table-column prop="orderCode" label="借款单号" align="center"></el-table-column>
            <el-table-column prop="orderCode" label="收款金额" align="center"></el-table-column>
            <el-table-column prop="orderCode" label="订单ID" align="收款账户"></el-table-column>
          </template>
          <!-- 解绑暂时不需要做 -->
      ...
      <div class="table_trip" v-if="tableData.length > 0 && tableData[0].collectionType == 6">
        <el-table
          ...
          :header-cell-style="getRowClass"
        >
          <el-table-column prop="sK_ID" label="收款单号" align="center"></el-table-column>
          ...
          <el-table-column prop="sk_Price" label="收款金额" align="center"></el-table-column>
      ...
      this.$http
        .post(
          this.GLOBAL.serverSrc +
            "/finance/bankofchina/api/FindAssociatedOrders",
          {
          ...
          if (obj.data.isSuccess) {
            ...
            that.tableData.forEach(function(item, index, arr) {
              ...
              item.createTime_dt =
                ...
                " " +
                item.createTime_dt.split("T")[1].split(".")[0];
