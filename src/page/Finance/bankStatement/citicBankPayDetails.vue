<template>
  <div class="distributor-content">
    ...
    <el-table :data="tableData" border :highlight-current-row="true" :header-cell-style="getRowClass" :stripe="true" id="table-content">
      ...
      <el-table-column prop="surplus_Amount" label="交易时间" align="center">
      </el-table-column>
      <el-table-column prop="transaction_time" label="商户订单号" align="center">
        <template slot-scope="scope">
          <span>{{scope.row.transaction_time.split('T')[0] + ' ' + scope.row.transaction_time.split('T')[1]}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="transaction_time" label="平台订单号" align="center">
        <template slot-scope="scope">
          <span>{{scope.row.transaction_time.split('T')[0] + ' ' + scope.row.transaction_time.split('T')[1]}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="transaction_amount" label="所属渠道" align="center">
      </el-table-column>
      <el-table-column prop="preferential_amount" label="商户编号" align="center">
      </el-table-column>
      <el-table-column prop="actual_amount" label="商户名称" align="center">
      </el-table-column>
      <el-table-column prop="refund_amount" label="支付类型" align="center">
      </el-table-column>
      <el-table-column prop="merchant_order_number" label="交易状态" align="center">
      </el-table-column>
      <el-table-column prop="platform_order_number" label="交易金额" align="center">
      </el-table-column>
      <el-table-column prop="channel" label="优惠金额" align="center">
      </el-table-column>
      <el-table-column prop="merchant_code" label="实收金额" align="center">
      </el-table-column>
      <el-table-column prop="merchant_name" label="退款金额" align="center">
      </el-table-column>
      <el-table-column prop="payment_type" label="币种" align="center">
      </el-table-column>
      <el-table-column prop="trading_status" label="交易类型" align="center">
      </el-table-column>
      <el-table-column prop="currency" label="交易发卡行" align="center">
      </el-table-column>
      <el-table-column prop="transaction_type" label="终端类型" align="center">
      </el-table-column>
      <el-table-column prop="transaction_issuer" label="商品名称" align="center">
      </el-table-column>
      <el-table-column prop="terminal_type" label="操作员编号" align="center">
      </el-table-column>
      <el-table-column prop="trade_name" label="设备号" align="center">
      </el-table-column>
      <el-table-column prop="operator_number" label="门店编号" align="center">
      </el-table-column>
      <el-table-column prop="device_number" label="第三方商户号" align="center">
      </el-table-column>
      <el-table-column prop="shop_number" label="APPid" align="center">
      </el-table-column>
      <el-table-column prop="third_party_merchant_number" label="第三方订单号" align="center">
      </el-table-column>
      <el-table-column prop="apPid" label="付款备注" align="center">
      </el-table-column>
      <el-table-column prop="third_party_order_number" label="剩余金额" align="center">
      </el-table-column>
