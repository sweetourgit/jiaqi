  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        word: [{ required: true, validator: hasWord, trigger: 'blur' }],
        origin: [{ required: true, validator: hasDes1, trigger: 'blur' }],
        destination: [{ required: true, validator: hasDes2, trigger: 'blur' }],
        returnDes: [{ required: true, validator: hasDes3, trigger: 'blur' }],
