<template>
  <div>
    ...
    <!--下单弹窗-->
    <el-dialog title="下单" :visible.sync="dialogFormOrder" custom-class="city_list dialogOrder" style="margin-top:-100px" append-to-body width="1000px" @close="cancelInfoOrder('ruleForm')">
       <div class="main1">
