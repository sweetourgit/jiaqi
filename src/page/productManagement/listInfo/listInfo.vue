      ...
      <el-tab-pane label="基本信息" name="first">
        <div>
          ...
          <el-form-item label="头图" prop="avatarImages" label-width="120px">
            ...
            <el-input v-model="ruleForm.avatarImages" disabled class="firstFigure"></el-input>
            ...
            <el-upload :on-preview="handleImgClick" class="upload-demo uploadimage" action="https://jsonplaceholder.typicode.com/posts/" list-type="picture" :limit='1' accept=".jpg,.png,.gif" :on-remove="handleRemove">
              ...
              <el-button type="info">
                ...
                <div v-show="isShowImg" class="upload_div">

                  <img class="upload_img" :src="this.imgUrl" alt="">
          ...
          <el-form-item label="视频" prop="video" label-width="120px">
            ...
            <el-input v-model="ruleForm.video" disabled class="firstFigure"></el-input>

            <el-upload class="upload-demo uploadimage" action="https://jsonplaceholder.typicode.com/posts/" list-type="picture" :limit='1' :on-remove="handleRemoves1">
      ...
      <el-tabs v-model="editableTabsValue" type="card" editable @edit="handleTabsEdit">
        <el-tab-pane :key="index" v-for="(item, index) in editableTabs" :label="item.title" :name="item.name">
          <!--套餐名-->
            ...
            <el-form-item class="setmeal" label="套餐名" prop="highlightWords" label-width="100px">
        ...
        rules: {
          productNamel: [{
...

            {
              ...
              pattern: /^[\u4e00-\u9fa5a-zA-Z0-9【】，+/]{1,28}([\u4e00-\u9fa5a-zA-Z0-9【】，+/（）]{0,2})$/,

              message: '请输入正确产品名称，含中括号【】中文逗号，英文+/可用，中文小括号（）仅能用在句尾'
