  ...
  <div>
    ...
    <div style="padding: 0 20px">
      <div style="text-align: left">
        ...
        <el-button
          v-else
          style="border:1px solid #3095fa;color:#3095fa;"
          class="add_scenic"
          @click="handleEdit"
        >编辑</el-button>
      ...
      >
        <el-table-column prop="id" label="景点ID" min-width="60" align="center" header-align="center"></el-table-column>
        <el-table-column label="景点名称" min-width="180" align="center" header-align="center">
...
export default {
  ...
  methods: {
    ...
    // 关闭addScenic对话框
    closeDialogAddScenic() {
      this.$refs.addScenicForm.form = {
        chineseName: "", // 中文名称
        englishName: "", // 英文名称
        areaId: {
          // 所属区域
    ...
    initData(areaVal, nameVal) {
      this.$http
        .post(this.GLOBAL.serverSrc + "/scenicspot/api/search", {
    ...
    dataLoading(is) {
      // 参考用时
      this.$http
        .post(this.GLOBAL.serverSrc + "/scenicspot/api/GetDictListByType", {
          object: {
            type: 2
          }
        })
        .then(res => {
          ...
          this.$http
            ...
            .then(val => {
              ...
              this.$http
                .post(
                  this.GLOBAL.serverSrc + "/scenicspot/api/GetDictListByType",
                  {
                    object: {
                      type: 1
                    }
    ...
    handleEdit() {
      this.$http
        .post(this.GLOBAL.serverSrc + "/scenicspot/api/get", {
    ...
    handleDelete() {
      this.$confirm("是否删除该景点信息?", {
        ...
        .then(() => {
          this.$http
            .post(this.GLOBAL.serverSrc + "/scenicspot/api/delete", {
              id: this.currentRow.id
            })
            .then(res => {
