      ...
      <el-tab-pane :key="index+''" v-for="(item, index) in editableTabs" :label="item.typeName" :name="index+''">
        <div class="labelBorder">
          <div class="searchBox">
            ...
            <el-table class="labelTable" :data="tableData" ref="multipleTable" border style="width: 100%":header-cell-style="getRowClass"@selection-change="changeFun":row-style="rowClass" @row-click="clickRow">
