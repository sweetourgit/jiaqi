    ...
    <el-dialog :title="topTitle" :visible="dialogFormVisible" style="margin:-80px 0 0 0;" custom-class="city_list" :show-close="false" width="70%" @close="closeAdd">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
        ...
        <div>
          ...
          <el-form-item label="面积：" prop="area" label-width="140px">
            <el-input v-model="ruleForm.area" class="inputWidth" placeholder="请输入"></el-input>
          </el-form-item>
          <el-form-item label="窗型：" prop="window" label-width="140px">
            <el-input v-model="ruleForm.window" class="inputWidth" placeholder="请输入"></el-input>
          </el-form-item>
