...
export default {
  ...
  methods: {
    ...
    getEnroll(){
      this.$http.post(this.GLOBAL.serverSrc + '/universal/enrolla/api/get',{
    ...
    addEnrollType(formName){
      this.$refs[formName].validate((valid) => {
          if (valid) {
            var _this = this;
            this.$http.post(this.GLOBAL.serverSrc + "/universal/enrolla/api/insert",
              {
                object: {
                  "id": 0,
                  "isDeleted": 0,
    ...
    editEnrollType(formName){
      var that = this
        this.$http.post(
          this.GLOBAL.serverSrc + "/universal/enrolla/api/save",
          {
            "object": {
              "id": this.multipleSelection[0].id,
              "isDeleted": 0,
    ...
    deleteEnroll(){
        ...
        .then(() => {
          this.$http.post(this.GLOBAL.serverSrc + '/universal/enrolla/api/delete',{
            "id": this.multipleSelection[0].id
          })
          .then(res => {
            if(res.data.isSuccess == true){
      ...
      /*pageList(){
        this.$http.post(this.GLOBAL.serverSrc + '/universal/enrolla/api/page', {
           "object": {
              "isDeleted": 0
           },
          ...
          this.$http.post(this.GLOBAL.serverSrc + '/universal/enrollb/api/page', {
            "object": {
              "isDeleted": 0
            },
           "pageSize":this.pagesize,
    ...
    pageList() {
      var that = this
      this.$http.post(
        this.GLOBAL.serverSrc + "/universal/enrolla/api/page",
        {
          "object": {
            "isDeleted": 0
          },
